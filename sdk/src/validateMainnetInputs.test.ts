...
test("parseInputs accepts a complete manifest with null optional values", () => {
  const inputs = parseInputs({
    ...
    destinationMint: "TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA",
    ...
    fundingAuthority: "Fund111111111111111111111111111111111111111",
    ...
    expectedRefundRecipient: "Fund111111111111111111111111111111111111111",
