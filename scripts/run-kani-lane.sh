...
HARNESSES=(
  ...
  "instructions::verification::unclaimed_withdrawal_gate_requires_now_strictly_above_end_ts"
  ...
  "state::verification::migration_config_refund_recipient_roundtrips_through_reserved_bytes"
  "state::verification::migration_config_unclaimed_withdrawn_flag_roundtrips"
