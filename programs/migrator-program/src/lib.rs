...
pub const ASSOCIATED_TOKEN_PROGRAM_ID: [u8; 32] = [
    0x02, 0x6C, 0x89, 0x79, 0xA4, 0xA8, 0x5A, 0xA7, 0x7A, 0x66, 0x91, 0xEF, 0x0D, 0x98, 0x84, 0xA5,
    0x91, 0xD9, 0x9F, 0x62, 0xF8, 0x14, 0x5E, 0xA1, 0x73, 0xB4, 0xF3, 0x57, 0xE7, 0x61, 0xF8, 0x59,
];
